...
export function Login(){
    ...
    return (<div className={styleLogin.div}>
        <form className={styleLogin.form} onSubmit={handleSubmit}>
            ...
            <input onChange={event => setUsername(event.target.value)} placeholder="Username" className={styleLogin.items} type="text"/>
            <input onChange={event => setPassword(event.target.value)} placeholder="passowrd" className={styleLogin.items}  type="password"/>
